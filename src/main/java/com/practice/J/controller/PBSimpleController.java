...
public class PBSimpleController {

    /*
    //추가 공부
    1. .proto 이용하여 protobufhttpmessageconverter 사용해보기
    2. DynamicMessage 를 이용한다면 httpmessageconverter를 커스텀해보기
    */
    private final ObjectMapper objectMapper;

    @PostMapping(value = "/jsontopb/v2", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    @PostMapping(value = "/pbtojson/v2", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
